                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <jsp:include page="bankmenu.jsp"></jsp:include>
...
<section class="signin-page account" style="border-style: dotted;">
	  ...
	  <table style=" width: 92%" border="0" >
		...
		try {
			...
			String quer = "select * from tbl_loan_process where Bank_Email_ID='"+email+"'";
...
String Status=rs.getString("Status_Loan");
        ...
        <td><div align="center"><%=rs.getString(11)%></div></td>
          ...
          <td><div align="center"><a href="loan_accecpt?id=<%=rs.getString(1)%>"><input type="button" name="submit" class="btn btn-primary pull-left" value="Accept"></a></div></td>
          <td><div align="center"><a href="loan_reject?iD=<%=rs.getString(1) %>"> <input type="button" name="submit" class="btn btn-primary pull-left" value="Reject"></a></div></td>
